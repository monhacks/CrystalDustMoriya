...
const u8 gText_PkmnCameBack[] = _(" came back!");
...
const u8 gText_ItemIsNowHeld[] = _(" is now held.");
const u8 gText_ChangedToNewItem[] = _("Changed to .");
...
const u8 gText_PokemonMaleLv[] = _("{COLOR_HIGHLIGHT_SHADOW LIGHT_RED WHITE GREEN}♂{COLOR_HIGHLIGHT_SHADOW DARK_GRAY WHITE LIGHT_GRAY}/{LV}{DYNAMIC 1}"); // Unused
const u8 gText_PokemonFemaleLv[] = _("{COLOR_HIGHLIGHT_SHADOW LIGHT_GREEN WHITE BLUE}♀{COLOR_HIGHLIGHT_SHADOW DARK_GRAY WHITE LIGHT_GRAY}/{LV}{DYNAMIC 1}"); // Unused
const u8 gText_PokemonNoGenderLv[] = _("/{LV}{DYNAMIC 1}"); // Unused
...
const u8 gText_NumberF700[] = _("No. ");
const u8 gText_RibbonsF700[] = _("RIBBONS ");
const u8 gText_PokemonMaleLv2[] = _("{COLOR_HIGHLIGHT_SHADOW LIGHT_RED WHITE GREEN}♂{COLOR_HIGHLIGHT_SHADOW DARK_GRAY WHITE LIGHT_GRAY}/{LV}{DYNAMIC 1}{DYNAMIC 2}"); // Unused
const u8 gText_PokemonFemaleLv2[] = _("{COLOR_HIGHLIGHT_SHADOW LIGHT_GREEN WHITE BLUE}♀{COLOR_HIGHLIGHT_SHADOW DARK_GRAY WHITE LIGHT_GRAY}/{LV}{DYNAMIC 1}{DYNAMIC 2}"); // Unused
const u8 gText_PokemonNoGenderLv2[] = _("/{LV}{DYNAMIC 1}{DYNAMIC 2}"); // Unused
...
const u8 gText_F700sQuiz[] = _("'s quiz");
...
const u8 gText_F700JoinedChat[] = _(" joined the chat!");
const u8 gText_F700LeftChat[] = _(" left the chat.");
const u8 gJPText_PlayersXPokemon[] = _("の{DYNAMIC 1}ひきめ:"); // Unused
const u8 gJPText_PlayersXPokmonDoesNotExist[] = _("の{DYNAMIC 1}ひきめは いません"); // Unused
const u8 gText_ExitingChat[] = _("Exiting the chat…");
const u8 gText_LeaderLeftEndingChat[] = _("The LEADER, , has\nleft, ending the chat.");
...
const u8 gText_PlayerSavedGame_Chat[] = _(" saved the game.");
...
ALIGNED(4) const u8 gText_1DotBlueF700[] = _("1. {COLOR BLUE}{SHADOW LIGHT_BLUE}");
ALIGNED(4) const u8 gText_1DotF700[] = _("1. ");
...
const u8 gText_F700Players[] = _(" players");
